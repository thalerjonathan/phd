    ...
    public void run() throws ExecutionException, InterruptedException {
        ...
        simulator.simulateWithObserver(sgAgents,
                ...
                new ISimulationObserver() {
                    @Override
                    public boolean simulationStep(LinkedHashMap genericAs) {
                        LinkedHashMap<Integer, SGAgent> as = genericAs;
                        Iterator<Map.Entry<Integer, SGAgent>> iter = as.entrySet().iterator();
                        while (iter.hasNext()) {
