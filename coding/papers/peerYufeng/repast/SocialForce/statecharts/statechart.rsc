...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_KHhDAcYhEeeUw-o55eNkPA" agentType="socialForce.Person" package="socialForce.chart" className="PersonStatechart" nextID="407" id="Person Statechart" uuid="_KHhDAMYhEeeUw-o55eNkPA">
    ...
    <transitions xmi:type="Transition" xmi:id="_MRzsIMYoEeeUw-o55eNkPA" from="_JpXDMMYoEeeUw-o55eNkPA" to="_H0KcIMYoEeeUw-o55eNkPA" onTransition="agent.arrivedDest = false;" outOfBranch="true" triggerType="condition" triggerConditionCode="return agent.roomNo >= get_Main().roomNum;" id="Transition 272" uuid="_MRzsIcYoEeeUw-o55eNkPA"/>
    <transitions xmi:type="Transition" xmi:id="_R9RaIMYoEeeUw-o55eNkPA" from="_JpXDMMYoEeeUw-o55eNkPA" to="_NPomUMYoEeeUw-o55eNkPA" onTransition="agent.arrivedDest = false;" outOfBranch="true" triggerType="condition" triggerConditionCode="return agent.roomNo &lt; get_Main().roomNum;" messageCheckerClass="Object" id="Transition 275" uuid="_R9RaIcYoEeeUw-o55eNkPA"/>
