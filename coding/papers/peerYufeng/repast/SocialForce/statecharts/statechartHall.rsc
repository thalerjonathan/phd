...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_bGDiAcqmEee3cuB2xVrVAA" agentType="socialForce.scenario.pillarHall.Person" package="socialForce.chart.pillarHall" className="PersonHallStatechart" nextID="345" id="Person Hall Statechart" uuid="_bGDiAMqmEee3cuB2xVrVAA">
