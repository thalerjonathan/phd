...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_bGDiAcqmEee3cuB2xVrVAA" agentType="socialForce.movable.Person" package="socialForce.chart.hall" className="PersonHallStatechart" nextID="492" id="Person Hall Statechart" uuid="_bGDiAMqmEee3cuB2xVrVAA">
    ...
    <transitions xmi:type="Transition" xmi:id="_9DVDUMqnEee3cuB2xVrVAA" from="_haBacMqmEee3cuB2xVrVAA" to="_6HdIEMqnEee3cuB2xVrVAA" onTransition="agent.resetAtDest();" triggerType="condition" triggerTime="0.01" triggerConditionCode="agent.isAtDest();" messageCheckerClass="Object" id="Transition 25" uuid="_9DVDUcqnEee3cuB2xVrVAA"/>
    <transitions xmi:type="Transition" xmi:id="_XMdj0MqyEee1D9WKHbF7jg" from="_6HdIEMqnEee3cuB2xVrVAA" to="_UvzUIMqyEee1D9WKHbF7jg" triggerType="condition" triggerTime="0.01" triggerConditionCode="return agent.isAtDest();" messageCheckerClass="Object" id="Transition 142" uuid="_XMdj0cqyEee1D9WKHbF7jg"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_mMEWsMqyEee1D9WKHbF7jg" from="_bg5NcMqyEee1D9WKHbF7jg" to="_kLuPkMqyEee1D9WKHbF7jg" outOfBranch="true" triggerType="condition" triggerConditionCode="return (Utils.uniform(0,1) &lt; Hall.EXIT_RATE) &amp;&amp; (false == agent.isInGroup());" triggerConditionCodeImports="import socialForce.misc.Utils;&#xA;import socialForce.scenario.hall.Hall;" messageCheckerClass="Object" id="Transition 156" uuid="_mMEWscqyEee1D9WKHbF7jg"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_thdP4MqyEee1D9WKHbF7jg" from="_sMqAIMqyEee1D9WKHbF7jg" to="_6HdIEMqnEee3cuB2xVrVAA" triggerType="condition" triggerTime="0.01" triggerConditionCode="return agent.isAtDest();" messageCheckerClass="Object" id="Transition 160" uuid="_thdP4cqyEee1D9WKHbF7jg"/>
    <transitions xmi:type="Transition" xmi:id="_2fjPcMq2Eee1D9WKHbF7jg" from="_kLuPkMqyEee1D9WKHbF7jg" to="_z_wMMMq2Eee1D9WKHbF7jg" onTransition="" triggerType="condition" triggerTime="0.01" triggerConditionCode="return agent.isAtDest();" messageCheckerClass="Object" id="Transition 273" uuid="_2fjPccq2Eee1D9WKHbF7jg"/>
    <transitions xmi:type="Transition" xmi:id="_71NFgMq2Eee1D9WKHbF7jg" from="_z_wMMMq2Eee1D9WKHbF7jg" to="_63zpIMq2Eee1D9WKHbF7jg" triggerType="condition" triggerTime="0.01" triggerConditionCode="return agent.isAtDest();" messageCheckerClass="Object" id="Transition 287" uuid="_71NskMq2Eee1D9WKHbF7jg"/>
  </StateMachine>
