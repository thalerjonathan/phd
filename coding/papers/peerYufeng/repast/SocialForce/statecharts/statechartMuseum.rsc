...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_KHhDAcYhEeeUw-o55eNkPA" agentType="socialForce.scenario.museum.Person" package="socialForce.chart.museum" className="PersonMuseumStatechart" nextID="580" id="Person Museum Statechart" uuid="_KHhDAMYhEeeUw-o55eNkPA">
