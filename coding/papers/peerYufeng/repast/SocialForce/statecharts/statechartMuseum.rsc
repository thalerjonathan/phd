...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_KHhDAcYhEeeUw-o55eNkPA" agentType="socialForce.scenario.museum.Person" package="socialForce.chart.museum" className="PersonMuseumStatechart" nextID="579" id="Person Museum Statechart" uuid="_KHhDAMYhEeeUw-o55eNkPA">
    ...
    <transitions xmi:type="Transition" xmi:id="_8EeCMMYkEeeUw-o55eNkPA" from="_0ZAyYMYkEeeUw-o55eNkPA" to="_0ZAyYMYkEeeUw-o55eNkPA" onTransition="agent.getNearestScreen();&#xA;agent.destX = (agent.destScreen.x + agent.destScreen.alliX) / Museum.METER_2_PX;&#xA;agent.destY = (agent.destScreen.y + agent.destScreen.alliY) / Museum.METER_2_PX;" triggerTime="0.1" messageCheckerClass="Object" id="Transition 125" uuid="_8Ef3YMYkEeeUw-o55eNkPA" selfTransition="true"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_NywzcMYmEeeUw-o55eNkPA" from="_Bcn9MMYmEeeUw-o55eNkPA" to="_KeSK8MYmEeeUw-o55eNkPA" outOfBranch="true" triggerType="condition" triggerTime="0.1" triggerConditionCode="return agent.shouldWaiting();" messageCheckerClass="Object" id="Transition 164" uuid="_NywzccYmEeeUw-o55eNkPA"/>
    <transitions xmi:type="Transition" xmi:id="_YKbx4MYmEeeUw-o55eNkPA" from="_Bcn9MMYmEeeUw-o55eNkPA" to="_TaBW4MYmEeeUw-o55eNkPA" outOfBranch="true" defaultTransition="true" triggerType="condition" triggerConditionCode="return false == agent.shouldWaiting();" messageCheckerClass="Object" id="Transition 174" uuid="_YKbx4cYmEeeUw-o55eNkPA"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_Jr0WwMYnEeeUw-o55eNkPA" from="_-SwMwMYmEeeUw-o55eNkPA" to="_TaBW4MYmEeeUw-o55eNkPA" onTransition="agent.arrivedDest = false;&#xA;agent.vi0 = Person.VI0_INIT;" triggerType="condition" triggerConditionCode="return agent.groupArrived >= agent.belongedGroup.people.size()-1;" messageCheckerClass="Object" id="Transition 192" uuid="_Jr2L8MYnEeeUw-o55eNkPA"/>
