...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented heroOrCowards and then executes a set of commands on the
	...
	public AgentSet<herosandcowards.relogo.HeroOrCoward> createHeroOrCowards(int number, Closure closure) {
		AgentSet<herosandcowards.relogo.HeroOrCoward> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"HeroOrCoward");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.HeroOrCoward")
	public AgentSet<herosandcowards.relogo.HeroOrCoward> createHeroOrCowards(int number) {
		return createHeroOrCowards(number,null);
	}

	/**
	 * Makes a number of uniformly fanned heroOrCowards and then executes a set of commands on the
	 * created heroOrCowards.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.HeroOrCoward")
	public AgentSet<herosandcowards.relogo.HeroOrCoward> createOrderedHeroOrCowards(int number, Closure closure) {
		AgentSet<herosandcowards.relogo.HeroOrCoward> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"HeroOrCoward");
		for (Turtle t : createResult){
			if (t instanceof herosandcowards.relogo.HeroOrCoward){
				result.add((herosandcowards.relogo.HeroOrCoward)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.HeroOrCoward")
	public AgentSet<herosandcowards.relogo.HeroOrCoward> createOrderedHeroOrCowards(int number) {
		return createOrderedHeroOrCowards(number,null);
	}
	...
	public AgentSet<herosandcowards.relogo.HeroOrCoward> heroOrCowards(){
		...
		for (Object e : this.getContext().getObjects(herosandcowards.relogo.HeroOrCoward.class)) {
	...
	public AgentSet<herosandcowards.relogo.HeroOrCoward> heroOrCowardsOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"heroOrCoward")){
			if (t instanceof herosandcowards.relogo.HeroOrCoward)
			result.add((herosandcowards.relogo.HeroOrCoward)t);
		}
		return result;
	...
	public AgentSet<herosandcowards.relogo.HeroOrCoward> heroOrCowardsOn(Turtle t){
		AgentSet<herosandcowards.relogo.HeroOrCoward> result = new AgentSet<herosandcowards.relogo.HeroOrCoward>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"heroOrCoward")){
	...
	public AgentSet<herosandcowards.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.UserTurtle")
	public AgentSet<herosandcowards.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.UserTurtle")
	public AgentSet<herosandcowards.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<herosandcowards.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.UserTurtle")
	public AgentSet<herosandcowards.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<herosandcowards.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(herosandcowards.relogo.UserTurtle.class)) {
	...
	public AgentSet<herosandcowards.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(herosandcowards.relogo.UserLink.class)) {
	...
	public herosandcowards.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (herosandcowards.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
