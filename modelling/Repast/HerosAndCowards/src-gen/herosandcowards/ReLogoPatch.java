...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new heroOrCowards and then executes a set of commands on the
	...
	public AgentSet<herosandcowards.relogo.HeroOrCoward> sproutHeroOrCowards(int number, Closure closure) {
		AgentSet<herosandcowards.relogo.HeroOrCoward> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"HeroOrCoward");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.HeroOrCoward")
	public AgentSet<herosandcowards.relogo.HeroOrCoward> sproutHeroOrCowards(int number) {
		return sproutHeroOrCowards(number,null);
	}
	...
	public AgentSet<herosandcowards.relogo.UserTurtle> sproutUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("herosandcowards.relogo.UserTurtle")
	public AgentSet<herosandcowards.relogo.UserTurtle> sproutUserTurtles(int number) {
