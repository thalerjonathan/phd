...
\title{ {\normalsize Research Proposal} \\ A dependently typed functional framework for the research of equilibrium-dynamics in agent-based bilateral trading and bartering.} % Title
