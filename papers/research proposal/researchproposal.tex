...
\subsection{Agent-based Economics}
...
\cite{Botta20114025} \\
\cite{Gintis2006} \\
TODO: Zero-Intelligence Models - Gode And Sunder \\

\subsubsection{Public Goods Game}
Continuous time and communication in a public-goods experiment - oprea, charness, friedman: showing how continuous time can be applied to public-goods game. using continuous and discrete time and free-form communication between persons where the actions which influenced the outcome were very limited and one-way: just sending a message how much they contribute.

\subsubsection{Artifical Economies}
\cite{gintis_dynamics_2007} \\
Emergent Macroeconomics An Agent-Based Approach to Business Fluctuations - Gatti, D., Gaffeo, E., Gallegati, M., Giulioni, G., Palestrini, A.\\

\subsubsection{Networks}
Contagion in Financial Networks - Paul Glasserman and H. Peyton Young\\
