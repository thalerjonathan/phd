...
% 2. parallel, lock-step update-strateg
% 3. introduce FRP conceptually and Arrowized programming using diagrams
%	-> Concept of a Signal function (signal ~ Time -> a)
%   -> combinators
% 4. Yampa FRP non monadic matches SD with high enough sampling: show susceptible agent
% 5. MSF to solve problem of correlated random numbers: only show types
...
\begin{frame}{Signal Function}
  TODO: Signal Function conceptually explained
  TODO: add diagrams and explain FRP and arrowized notation on high level
\end{frame}

\begin{frame}{FRP Combinators}
  TODO: switch
  TODO: occasionally
  TODO: after
  TODO: noiseR
...
\begin{center}
	\begin{tabular}{c c}
		\begin{subfigure}[b]{0.42\textwidth}
			\centering
			\includegraphics[width=1\textwidth, angle=0]{./fig/SIR_Yampa_dt01.png}
...
\begin{center}
	\begin{tabular}{c c}
		\begin{subfigure}[b]{0.42\textwidth}
			\centering
			\includegraphics[width=1\textwidth, angle=0]{./fig/SIR_Yampa_dt001.png}
			\caption{Agent-Based approach}
		\end{subfigure}
...
\begin{frame}{Reflection}
  \begin{itemize}
	...
	\item \textbf{Parallel, lock-step semantics}
	\item Problem: Correlated Random Numbers !!
	\item Missing: Spatiality
  \end{itemize}
\end{frame}
...
\begin{frame}{Monadic Stream Functions}
  TODO
\end{frame}
...
\begin{frame}[fragile]{Re-defining Some Types}
\begin{minted}[fontsize=\tiny, linenos]{haskell}
