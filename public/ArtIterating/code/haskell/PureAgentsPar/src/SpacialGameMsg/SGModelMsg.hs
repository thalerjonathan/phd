...
sgTransformer (a, ge, le) PA.Start = (broadCastLocalState a, le)
sgTransformer (a, ge, le) (PA.Dt dt) = (a, le)                                    -- NOTE: no action on time-advance
sgTransformer (a, ge, le) (PA.Message (_, m)) = (sgMsg a m, le)           -- NOTE: ignore sender
