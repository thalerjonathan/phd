...
absStateLift :: StateT ABSState (StateT SugEnvironment (Rand g)) a -> AgentAction g a
absStateLift = lift 

envLift :: StateT SugEnvironment (Rand g) a -> AgentAction g a
envLift = lift . lift

randLift :: Rand g a -> AgentAction g a
