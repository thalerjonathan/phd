...
-- clear & stack exec -- sugarscape -s "Animation IV-5" -f 1000 -o export/dynamics.m -r 42
-- clear & stack exec -- sugarscape -s "Animation IV-5" -v 0 --ac Default --sc Resource -r 42
