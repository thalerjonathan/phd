...
After a quick googling I found out that the model is called Markov switching multifractal \url{https://en.wikipedia.org/wiki/Markov_switching_multifractal} 
It looks mathematically VERY difficult.