...
\chapter{Pure functional: Haskell} 
...
\section{Structuring Functional Programs}

\subsection{Higher Order Functions}
map \& fmap, foldl, applicatives
\cite{hutton_programming_2007} gives a great overview and motivation for using fmap, applicatives and Monads 
