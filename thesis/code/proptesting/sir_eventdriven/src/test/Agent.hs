          ...
          Infected -> 
            if ao /= Infected
              ...
              -- infected, check invariants
                ...
                return $ cover 1 True "Susceptible became Infected" ret
  where
