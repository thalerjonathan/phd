...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%555
%NOTES DURING INCORPORATING EDITORS CHANGES
% Should I explain the concept of a Monad more in detail e.g. providing type signatures / type class definitions, actual implementations e.g. Maybe?  also need to provide Functor and Applicative implementations

% can we show that monads do not compose generally and therefore need a Transformer?

% Should I explain the concept of a Monad Transformer more in detail e.g. providing type signatures and provide an actual implementation e.g. MaybeT?

% Should I explain Arrows more in detail e.g. providing type signatures and provide an actual implementation?

% show that time leaks are not possible in arrowised FRP: 
...
% Should I extend the Methodology?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
