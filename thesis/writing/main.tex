...
% Structure only 3 main parts: introducation, research, discussion
% Introduction: noch ein wenig besser verkaufen
% APPENDIX: correct by construction SD appendix passt nicht rein, auf arxiv tun
% APPENDIX: equilibrium, raus
% Introduction, discussion and conclusion müssen extrem sitzen: es muss ganz ganz klar sein warum, motivation, wissenslücke, was die contribution ist
% Event driven: language pragmas im code entfernen und kurz am anfang klar machen dass ein paar notwendig sind aber die zwecks dem fluss und conceptual nicht gelistet werden.
...
%
%   \item pro-active (currently) vs. pro active vs. proactive
%
...
%	
%	\item weaken the statement “Unfortunately the established programming languages in the field, Python, Java, and C++, are not very well suited to tackle the complexities of parallel programming”. For instances, Java (starting from version 5) offers a lot of data structures for dealing with parallel and distributed programs. If authors think the sentence is valid, it requires to be strongly motivated and contextualized. 
%
