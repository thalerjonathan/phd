...
\input{./tex/concurrentabs.tex}

\input{./tex/property.tex}

% NOTE: this is beyond the scope of this thesis, I will be occupied enough with the intermission part where I look into the structure of ABS computation in general (co-monads, co-inductive streams,...)
%\epigraphhead[450]{}
%\part{Towards Dependent Types}
%\input{./tex/dependent/dependent.tex}
