...
\begin{enumerate}
	\item MODERATE EFFORT: Write methodology section
	\item MODERATE EFFORT: Functional programming: write transformers section, explaining how to stack effects, in which order lifts happening, also explain MTL and effects through typeclasses
	\item MODERATE EFFORT: Discussion How: fix missing OO definition
...
\begin{enumerate}
	\item MANDATORY, HIGH EFFORT: refine/rewrite event-driven implementation, it is too ad-hoc and the weakest (finished) chapter atm

	\item MANDATORY, HIGH EFFORT: write "The structure of ABS computation" section: extract the foundational properties: introduce continuations and closures and show how they are used in SF and MSF to be simple immutable objects, further discuss agents as monad / comonad / arrow and discuss their implications from an abstract point of view.
	
	\item MANDATORY, HIGH EFFORT: write "Gintis Case Revisited" as it will be highly important for my internal assessor. Try to get the implementation working and refactor it into a functional implementation, atm it is awful
