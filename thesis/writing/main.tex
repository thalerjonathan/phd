...
\begin{enumerate}
	\item finish property-base testing work in Haskell: time-driven agent specifications and make sense of the SIR model verification which does not work: either give an in-depth explanation why not and why our implementation is still valid or find a way of solving it.
	
	\item implement SIR equilibrium-totality correspondence in Idris, closely related to the property-based testing
	
	\item implement Gintis Case-Study and focus on property-tests and reasoning and potential directions for a dependently-typed implementation
\end{enumerate}
