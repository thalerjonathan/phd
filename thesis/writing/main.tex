...
\begin{enumerate}
	...
	\item implement Gintis Case-Study with Haskell
	
	\item implement Gintis Case-Study with Idris
	
	\item implement read-only increment next agent id monad
\end{enumerate}

TODO: cleaning up / polishing:
\begin{enumerate}
