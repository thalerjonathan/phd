...
\begin{enumerate}
	...
	\item completely understand monads (read / do all about monads): be able to derive and explain them
	
	\item completely understand continuations: be able to derive and explain them
		
	\item completely understand arrows: be able to derive and explain them
	
	\item be able to produce the proof of non computable as given in the book on computation (because i often mention it)	
