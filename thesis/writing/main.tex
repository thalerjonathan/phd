...
\begin{enumerate}
	\item draft introduction: clean up and make coherent, not too much work
	\item draft background and methodology: needs overhaul and focussing, put SIR and Sugarscape in there, short monad transformer section in methodology)
	
	\item LEAVE THE THESIS ASIDE FOR AT LEAST 2 WEEKS AND PICK UP WORK AFTER
		
	\item read whole thesis front to back and point out weaknesses in each chapter
\end{enumerate}
