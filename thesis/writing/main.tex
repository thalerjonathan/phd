...
\begin{enumerate}
	...
	\item OPTIONAL, MODERATE EFFORT: write "Gintis Case Revisited" as it will be highly important for my internal assessor. Try to get the implementation working and refactor it into a functional implementation, atm it is awful. If its too much effort, condense into a shorter section and put it into the Discussion chapter.
