...
% Should I explain the concept of a Monad more in detail e.g. providing type signatures / type class definitions, actual implementations? 

% Should I explain the concept of a Monad Transformer more in detail e.g. providing type signatures and provide an actual implementation e.g. Maybe? also need to provide Functor and Applicative

% Should I explain Arrows more in detail e.g. providing type signatures and provide an actual implementation?

% can we show that monads do not compose generally?
