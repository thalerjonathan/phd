...
\begin{enumerate}
	\item polish references
	\begin{itemize}
		\item check for each if it makes sense and hand-tweak them if not ok	, DOI?	
		\item add hyperlinks using howpublished in case it is a blog or website (e.g. stephen diel what i wish...)
	\end{itemize}
