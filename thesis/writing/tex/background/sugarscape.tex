...
\begin{center}
	...
	\caption{Visualisation of our Sugarscape implementation (see Chapter \ref{sec:advanced_eventdriven_ABS}). The naming of the respective \textit{Animation} and \textit{Figure} is taken from \cite{epstein_growing_1996}.} 
