...
There does not exist a commonly agreed upon definition of objects and OO but it is agreed that the original idea of objects was conceived by Alan Kay, the inventor of the SmallTalk language \footnote{\url{http://wiki.c2.com/?HeInventedTheTerm}}.  citation? and it contained the fundamental concepts \footnote{\url{http://wiki.c2.com/?AlanKaysDefinitionOfObjectOriented}}:
...
READ again https://www.tedinski.com/2018/02/13/inheritance-modularity.html
