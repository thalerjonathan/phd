...
\paragraph{Part \ref{part:implementation}} presents \textit{how} to do ABS in pure functional programming. 
\medskip
...
\paragraph{Part \ref{part:discussion}} is the closing part which looks at the thesis as a whole, discusses and concludes.
\medskip
