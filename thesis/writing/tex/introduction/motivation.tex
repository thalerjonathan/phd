...
%You should start with your motivation for doing this research (give a brief overview of the research background), identify the current problem, and then state your aims and objectives, before talking about the contributions. In the introduction you provide the context.
...
%TODO add iot reference from summersim conference as support
%TODO emphasise on distributed MAS systems

%TODO maybe we can use macal paper \cite{macal_everything_2016} for emphasising importance: very good survey/review paper on ABMS in General. fp can help with challenges h2, h4 and h5. also fp can help macals added transparency challenge, my thesis in general also adresses the knowledge challenge of macal "lack of abms educational...", further STM might be one way of tackling large-scale ABS as identified as Research Challenge by macal. also this paper supports that ABS is a fundamentally new technique that offers the Potential to solve problems that are not robustly addressed by other methods
