...
TODO: use an indexed Array with MVar and IORef for a better comparison with TArray - we still hypothesize that STM outperforms IO but with less difference
