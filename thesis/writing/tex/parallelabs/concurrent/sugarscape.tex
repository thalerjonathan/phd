...
\begin{table}
	...
	\begin{tabular}{cc|c|c}
		...
		\multicolumn{1}{ |c| }{1} & 39.4 & -     \\ \hline \hline 
		
		\multicolumn{1}{ c||  }{\multirow{4}{*}{Lock-Based} } &
		\multicolumn{1}{ |c| }{1} & 43.0 & -       \\ \cline{2-4}
		\multicolumn{1}{ c||  }{}                       &
		\multicolumn{1}{ |c| }{2} & 51.8 & -   \\ \cline{2-4}
		\multicolumn{1}{ c||  }{}                       &
		\multicolumn{1}{ |c| }{3} & 57.4 & -   \\ \cline{2-4}
		\multicolumn{1}{ c||  }{}                       &
		\multicolumn{1}{ |c| }{4} & 58.1 & -   \\ \hline \hline 
	...
	\end{tabular}  	
  	...
  	\caption{Steps per second (higher is better) and retries ratio (lower is better) on 50x50 grid with 500 initial agents on varying cores.}
...
\begin{table}
	\centering
  	...
  	\caption{Steps per second (higher is better) on 50x50 grid with varying number of agents with 4 (and 3) cores except the \textit{Sequential} (1 core) implementation.}
...
\begin{figure}
	...
	\caption{Steps per second (higher is better) on 50x50 grid and varying number of agents with 4 (and 3) cores except the \textit{Sequential} (1 core) implementation.}
...
%   	\end{tabular}
	...
	\end{tabular}  	
  	...
  	\caption{Steps per second (higher is better) on 16 and 32 cores on Amazon EC2.}
