...
\begin{table}
	...
	\begin{tabular}{ c || c | c | c }
		...
		(1) and (2) combined			 & TODO     & TODO       & TODO \\ \hline
	\end{tabular}
...
Thus when comparing the parallel CPU bound approach (1) to the IO bound sequential ones (2) and (3) results in a lower speed up factor of roughly 2.6.
