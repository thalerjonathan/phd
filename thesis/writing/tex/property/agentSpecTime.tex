...
The signal function \textit{constant} is the \textit{const} function lifted into an arrow: \textit{constant b = arr (const b)}. This should be proof enough that a recovered agent will stay recovered \textit{forever}. We discuss this the topic of computability in pure functional ABS in a slightly different context in Appendix \ref{app:equilibrium_totality}.