...
prop_sir_invariants :: Positive Int    -- ^ beta, contact rate
                    ...
                    -> [SIRState]      -- ^ population
                    -> Property
prop_sir_invariants (Positive cor) (UnitRange inf) (Positive ild) (TimeRange t) as  = property (do
  -- total agent count
  let n = length ss

  -- run the SIR simulation with UNRESTRICTED time
...
criteras for termination
- finite number of susceptible
- finite number of infected
- finite illness duration
