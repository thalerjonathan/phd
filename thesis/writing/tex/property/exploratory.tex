...
%Running Model Tests...
%
%Testing Disease Dynamics All Recover ...
%+++ OK, passed 10 tests.
%
%Testing Disease Dynamics Minority Recover ...
%+++ OK, passed 10 tests.
%
%Testing Trading Dynamics ...
%*** Failed! Falsified (after 3 tests):
%*** Failed! Falsified (after 8 tests):
%+++ OK, passed 10 tests; 2 failed (16%).
%
%Testing Cultural Dynamics ...
%*** Failed! Falsified (after 3 tests):
%*** Failed! Falsified (after 3 tests):
%*** Failed! Falsified (after 3 tests):
%+++ OK, passed 10 tests; 3 failed (23%).
%
%Testing Inheritance Gini ...
% TODO
%
%Testing Carrying Capacity ...
%+++ OK, passed 10 tests; 2 failed (16%).
%
%Testing Terracing ...
% TODO
%
%Running Model Tests finished.
%--------------------------------------------------------------------------------
...
\begin{enumerate}
	...
	\item Inheritance Gini Coefficient: \textit{TODO}
