...
%   	\end{tabular}
	...
	\end{tabular}  	
  	...
  	\caption[Sugarscape \textit{STM} performance on 16 and 32 cores on Amazon EC2]{Sugarscape \textit{STM} performance on 16 and 32 cores on Amazon EC2. Values are steps per second (higher is better).}
