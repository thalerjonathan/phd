...
%   	\end{tabular}
	...
	\end{tabular}  	
  	...
  	\caption[Steps per second of Sugarscape \textit{STM} on 16 and 32 cores on Amazon EC2]{Steps per second (higher is better) of Sugarscape \textit{STM} on 16 and 32 cores on Amazon EC2.}
