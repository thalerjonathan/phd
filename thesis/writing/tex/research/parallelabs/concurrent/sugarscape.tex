...
\begin{figure}
	\includegraphics[width=0.9\textwidth, angle=0]{./fig/concurrentabs/sugarscape/sugarscape_varyingcores_constagents.png}
...
\begin{figure}
	\includegraphics[width=0.9\textwidth, angle=0]{./fig/concurrentabs/sugarscape/sugarscape_varyingagents_constcores.png}
