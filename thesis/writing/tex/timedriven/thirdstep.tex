...
\subsection{Results}
We implemented rendering of the environments using the gloss \footnote{\url{http://hackage.haskell.org/package/gloss}} library which enabled us to cycle arbitrarily through the steps and inspect the spreading of the disease over time visually as seen in Figure \ref{fig:sir_dunai}.
