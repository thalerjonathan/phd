...
\begin{enumerate}
\item implement all the strategies in Java to REALLY have a comparison with Haskell

\item let each agent let collect its own messages by providing the (copy) of all agents
