...
TODO: mention that thus an agent-based simulation is a discrete time-simulation where time is broken down into continuous (REAL-Valued) or Discrete (Natural-valued) time-steps
