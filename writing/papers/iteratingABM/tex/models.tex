\section{Results}
In this section we will revisit the Prisoners Dilemma model of \cite{nowak_evolutionary_1992} and the Heroes \& Cowards model of \cite{wilensky_introduction_2015} and present results simulating both with our four update-strategies. 
...
\begin{figure}[H]
	\centering
  \includegraphics[width=.45\textwidth, angle=0]{./fig/con_HAC_100_000_500steps_haskell.png}
