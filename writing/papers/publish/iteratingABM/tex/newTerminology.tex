...
\subsection{3.2 ABS Update-Strategies}

\subsubsection{3.2.1 Sequential Strategy}
...
\subsubsection{3.2.2 Parallel Strategy}
...
\subsubsection{3.2.3 Concurrent Strategy}
...
\subsubsection{3.2.4 Actor Strategy}
