...
%TODO The hyperlinks in the text must show the URL such that someone reading a paper copy can see it. The recommended way (see the guidelines http://scs.org/authorskit) is to put the URL in the reference list, and add a citation in the text after the hyperlink.
%TODO The De Vries reference in the reference list is incomplete and missing the period after the author name.
