...
TODO INCORPORATE FEEDBACK FROM REVIEWER: Property-based testing is a conventional, still partially unexplored topic which is worthy of investigation. The manuscritpt has merits and it is interesting and sound. Overall style is good but a proof-reading is suggested to fix minors and typos listed below. A table summarizing contents surveyed in section 2 would improve readability. Try contextualizing agent-based simulation in the topic and mainstream Internet of Things context because simulation is even more interesting when it deals with cyberphysical systems. To this end, cite  and . In my opionion, this would definitively improve tha appeal and freshness of the paper.
