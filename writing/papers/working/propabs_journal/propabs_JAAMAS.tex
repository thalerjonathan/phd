...
\begin{abstract}
TODO: state the problem: code testing not very present in ABS research, unit testing does not scale well to ABS, therefore property-based testing. Expanding previous conceptual work by clearly showing the technical aspect of it
