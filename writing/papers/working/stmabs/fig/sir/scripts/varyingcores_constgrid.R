...
plot(cores, lbNaive, type="o", col="red", pch="o", lty=1,
     xlab = "Cores", 
     ylab = "Seconds",
     ylim=c(10,60),
...
lines(cores, lbRw, col="blue",lty=2)

points(cores, hyb, col="dark green",pch="+")
lines(cores, hyb, col="dark green", lty=3)

points(cores, stm, col="black",pch="*")
lines(cores, stm, col="black", lty=4)

legend("bottomleft", 
      legend=c("Lock-Based Naive","Lock-Based Read-Write","Hybrid", "STM"), 
