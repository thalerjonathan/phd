...
\begin{abstract}
TODO: feedback by thorsten: its too hardcore! first write a paper "how to arrive at FrABS from Haskell to Yampa to FrABS" in which we (thorsten and me) derive step-by-step an implementation of a very simple agent-based model using Haskell and Yampa. The conclusion will then be that we provide all stuff already in FrABS
