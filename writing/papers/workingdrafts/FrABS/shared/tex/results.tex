\section{Results}
TODO: show results with dt = 1.0 and 10,000 agents

TODO: can now introduce hypothesis here why we need to sample the system? because its functional reactive and continuous, thus we run into sampling problems
...
\subsection{Randomness and Super-Sampling}
...
\subsection{The final detail: Message Round-Trips}
