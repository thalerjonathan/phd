...
\begin{abstract}
TODO: also use SIR model with the main punch: FrABS can do agent-based simulation in a continuous time setting but with agents, so combining the best of both SD and ABS approaches.
