...
TODO: appendices
TODO: appendix: example overviews - shortly describes the examples implemented, if they use pure, monadic or reactive approaches (or all of it), the iteration strategy they work with, how they treat the environment (collapsing yes/no), 
	- SugarScape
	- Agent_Zero
	- SchellingSegregation
	- Prisoners Dilemma when finished
	- Heroes & Cowards when finished
	- SIRS, FrSpatialSIRS, FrNetworkSIRS
	- SysDynSIR
	- WildFire
	- DoubleAuction (Breuer et al)
	
TODO: appendix: recursive ABS - a short explanation of the idea behind it and a reference to the example of schelling segregation
\end{document}