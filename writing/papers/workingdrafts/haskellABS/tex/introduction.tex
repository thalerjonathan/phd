...
In this paper the absolute main focus is to show the benefits and drawbacks of using Haskell in ABS in COMPARISON to existing technologies in this field: NetLogo, AnyLogic, Repast, Java in general. What is easier in Haskell, what is more difficult? What can be done, what cant be done?
