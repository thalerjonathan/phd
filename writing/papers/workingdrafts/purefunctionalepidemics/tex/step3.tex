...
TODO: clearly state that this is inspired by object-oriented approaches and that this is the main difficulty in pure functional approaches: communication between agents. Note that in object-oriented approaches communication between agents is much more straight forward and can be achieved directly using method-calls between agents.
