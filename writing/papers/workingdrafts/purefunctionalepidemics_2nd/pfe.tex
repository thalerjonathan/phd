...
TODO: work internal to the paper
	TODO correlation in Yampa version: A) fix it or B) mention that this is actually a problem and simply wrong in Simulation (but not in a game), the next step solves that problem, and leave the bug in as an educational example where functional programming can encourage bugs if not carefully thinking about it
