...
%REFEREE TODO: "i wasnt entirely convinced by the discussion of dependent typing, explain less obvious points more clearly" => cut down a bit, as it really seems that we spend too much space there, also this is obviously not clear yet as it is FURTHER RESEARCH but we want to follow the indexed monad approach as explained in various papers by Brady todo cite.
