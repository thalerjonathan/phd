...
TODO: Functional programming is not necessarily slower but some concepts can be. We build on the concepts developed in \cite{thaler_pure_2019} to implement our ABS which makes heavy use of Functional Reactive Programming, which can be substantially slower than imperative approaches. Also laziness is a problem which could make things quite slow.
