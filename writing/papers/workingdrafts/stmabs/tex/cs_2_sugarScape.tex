...
\begin{table}
	\centering
  	\begin{tabular}{ c || c | c | c | c }
    	...
    	500     & 14.4       & 20.2		  &	20.1            & 18.5       	 & TODO 74.4 \\ \hline
   		1,000   & 6.8        & 10.8 	  & 10.4            & 9.5       	 & TODO 56.8 \\ \hline
   		1,500   & 4.7        & 8.1 		  & 7.9             & 7.3			 & TODO 45.2 \\ \hline
   		2,000   & 4.4        & 7.6 		  & 7.4             & 6.7    		 & TODO 37.0 \\ \hline 
   		2,500   & 5.3        & 5.4 		  & 9.2             & 8.9			 & TODO 31.7
   	\end{tabular}
...
What seems to be very surprising is that in all cases except the Lock-Based implementation the performance with 2,500 agents is \textit{better} than the one with 2,000 agents. The reason for this is that in the case of 2,500 agents, when an agent tries to move it can't move anywhere because all cells are already occupied

Why better performance with 2,500 than 2000 in Seqeuential and TVar 3,4 and TArray? because lazyness of haskell AND agents don't need to measure best cell because they know there is no place to go so they stay. This is in general observable: the higher the numbers the smoother the performance decrease. The exception is the lock-based approach which locks in any case - this shows another benefit of the STM approach over the lock-based.
