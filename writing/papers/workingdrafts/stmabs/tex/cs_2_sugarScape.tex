	...
	\centering
  	\begin{tabular}{ c || c | c | c | c | c }
    	...
    	500     & 14.4       & 20.2		  &	20.1           & 18.5       	& 71.9    \\ \hline
   		...
   		2,500   & 5.3        & 5.4 		  & 9.2            & 8.9			& 33.3    \\ \hline \hline
   	\end{tabular}
	...
	\centering
  	\begin{tabular}{ c || c | c | c }
    	...
    	Lock-Based & 32    & 44.2              & 3.6         \\ \hline \hline 
   		...
   		STM TArray & 16    & 116.8 (0.23)      & 39.5 (0.08) \\ \hline
