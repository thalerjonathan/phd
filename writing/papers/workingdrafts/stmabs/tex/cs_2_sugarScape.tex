	...
	\centering
  	\begin{tabular}{ c || c | c | c }
    	...
    	State  & 1     & 1,693.1 (8.305)  & 28.219 (0.138) \\ \hline \hline
   		...
   		STM    & 4     & 2,238.8 (36.307) & 37.312 (0.605) \\ \hline \hline
   	\end{tabular}
...
mean (retries) = 1646800
std (retries)  = 29939

mean (retries) / mean (commits) = 3.3825

\begin{table}
	\centering
  	\begin{tabular}{ c || c | c | c }
        Cores & Commits           & Retries            & Ratio \\ \hline \hline 
    	1     & 498,881 (3,042.4) & 2,407.8 (248.56)   & 0.004 \\ \hline \hline
...
Running concurrently is basically wrong because could lead to runs where the regrowth happens after the agent harvests which violates the model specifications. 

\subsection{From TVar to TArray}

\subsection{Scaling up Environment}
...
they are running it on 128x128 and on 10 year old single-core machines  \cite{lysenko_framework_2008}
