...
1.) implement full-fledged pure functional ABS library on top of Haskell and FRP (Yampa): FrABS
	-> includes a very basic view on ABS from the perspective of category-theory
2.) Case-study in verification: Sugarscapes decentralized  bilateral trading 
3.) Case-study in validation: Agent\_Zero network extension
...
\subsubsection*{Submitted Paper on FrABS}
