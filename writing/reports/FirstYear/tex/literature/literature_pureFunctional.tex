...
We need to build our motivation by first showing the basic usefulness and concepts of functional programming through classic papers. 

TODO: read \cite{backus_can_1978}
TODO: read \cite{hughes_why_1989}
TODO: read \cite{wadler_essence_1992}
TODO: read \cite{hudak_haskell_1994}: pure functional haskell is extremeply productive and code seems to look like specification 

then go into deeper problems like structuring functional programs (Monads, arrows) because the question is how can we build an ABS out of a functional language which does NOT have objects and methods, thus we immediately have to ask the question of structure
TODO: read \cite{wadler_monads_1995}
TODO: read \cite{wadler_how_1997}
TODO: read \cite{hughes_programming_2005}
