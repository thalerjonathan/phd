...
\begin{enumerate}
	...
	\item Investigate how far we can narrow the gap between model-specification and implementation using dependent types in Agent-Based Simulation. %, exploring the correspondence between the constructive nature of ABS and dependent types.
\end{enumerate}