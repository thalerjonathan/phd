...
TODO: state-machine : S -> I -> R 
TODO: timed transition from I -> R
TODO: 2d environment
TODO: equilibrium \& totality
...
the sugarscape model is of fundamental difference to the SIR one: it is of exploratory nature and has no underlying "ground-truth" as the SIR with its differential equations has. What implications has this? TODO: does it have any?
