...
TODO: when testing is costly because finding out if the simulation is correct (validation) takes multiple hours e.g. because running it takes so long, then guaranteeing properties and correctness already at compile time can reduce that bottleneck substantially.
